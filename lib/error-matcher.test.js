...
(0, ava_1.default)("queryMetadataError matches against example log output", async (t) => {
    t.assert(testErrorMatcher("queryMetadataError", "A fatal error occurred: Could not process query metadata for test-query.ql"));
});
